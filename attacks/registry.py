...
CATEGORIES: Dict[str, List[AttackSpec]] = {
    ...
    "2) Interceptação e Exploração de Rede": [
        A(
            id="net_arp_spoof",
            name="ARP Spoof",
    ...
    "4) Força Bruta em aplicações de acesso remoto": [
        A(
            id="bf_ssh",
            name="SSH Bruteforce",
    ...
    "6) Negação de Serviço e Impacto": [
        A(
            id="dos_http_simple",
